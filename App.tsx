...
import SignupRoutes from "./src/components/navigator/SignupRoutes";
  ...
  return (
    <NavigationContainer>
      <Tab.Navigator initialRouteName="Home">
        <Tab.Screen name="홈" component={HomeStack} options={{ headerShown: false, tabBarIcon: () => <AntDesign name="home" size={30} color="#5299EB" /> }} />
        <Tab.Screen
          name="게시판"
