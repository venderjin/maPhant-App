    ...
    <View style={styles.container}>
      ...
      <View style={styles.total}>
        ...
        {expandedItems.includes("terms") && (
          <Text>
            개인정보 수집 이용 동의서
            1. 수집하는 개인정보 항목 학교, 학과, 학번 2. 개인정보의 수집 및 이용 목적 제공하신 정보는 과끼리 앱 사용 확인을 위해 사용합니다. 본인 확인 식별 (동명이인 등) 절차에 이용(학교, 학과,학번) 2의사소통 및 정보 전달 등에 이용 (학교,학과,학번) 3. 개인정보의 보유 및 이용기간 수집된 개인정보의 보유 기간은 &lt;과끼리&gt; 사용 후 탈퇴 시, 당사자는 개인정보를 재생 불가능한 방법으로 즉시 파기합니다. 귀하는 이에 대한 동의를 거부할 수 있습니다. 다만 동의가 없을 경우 &lt;과끼리&gt; 사용이 불가능할 수도 있음을 알려드립니다.
          </Text>
        )}
      </View>
      <View style={styles.termsContainer}>
        ...
        {expandedItems.includes("another") && (
          <Text>
            개인정보 보호법에 따라 과끼리에 회원가입을 신청하시는 분께 수집하는
            개인정보의 항목, 개인정보의 항목, 개인정보의 수집 및 이용 목적, 개인정보의
            보유 및 이용 기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내드리오니
      ...
      <TouchableOpacity
        style={[styles.button,
        buttonColor ? null : styles.disabledButton]}
